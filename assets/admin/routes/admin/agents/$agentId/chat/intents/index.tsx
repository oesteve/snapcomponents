...
import {createIntent, useQueryComponents, useQueryTools} from "@/lib/agents/chat.ts";
...
function CreateIntent() {
    ...
    return (
        <div className="p-2">
            <Form onSubmit={createIntentMutation.mutateAsync}
                ...
                <Card className="w-full max-w-4xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Create a new intent for your agent to handle specific user requests
                        </CardDescription>
                        <CardAction>
                            <Submit>
                                Create Intent
