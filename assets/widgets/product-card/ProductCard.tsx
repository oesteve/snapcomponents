...
export default function ProductCard({title, price, image, onAddProductToCart}: ProductCardProps) {


    function handleAddToCart(e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) {
        ...
        <div
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span
                        className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-sm dark:bg-blue-200 dark:text-blue-800 ms-3">5.0</span>
                </div>
