...
export function RemoveArticleDialog({article, onRemoved}: RemoveArticleDialogProps) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Are you sure you want to remove the article "{article.name}"?
                        This action cannot be undone.
                    </DialogDescription>
                </DialogHeader>
                <Form className="grid gap-4" onSubmit={removeArticleMutation.mutateAsync}>
                    <FormError/>
                    <DevFormData/>
